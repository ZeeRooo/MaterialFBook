...
public class NotificationsJIS extends JobIntentService {
    ...
    void SyncNotifications() {
        ...
        try {
            Document doc = Jsoup.connect("https://m.facebook.com/notifications.php").timeout(600000).cookie(("https://m.facebook.com"), CookieManager.getInstance().getCookie(("https://m.facebook.com"))).get();
    ...
    void SyncMessages() {
        ...
        try {
            Document doc = Jsoup.connect("https://m.facebook.com/messages?soft=messages").timeout(600000).cookie(("https://m.facebook.com"), CookieManager.getInstance().getCookie(("https://m.facebook.com"))).get();
